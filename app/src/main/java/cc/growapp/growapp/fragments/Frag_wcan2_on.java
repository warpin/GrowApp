...
public class Frag_wcan2_on extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.frag_wcan2_on, container, false);
        //v.setBackgroundResource(R.drawable.anim_right_shower);

        ImageView f = (ImageView) v.findViewById(R.id.frag_wcan2_img);
        f.setImageResource(R.drawable.anim_wcan2);
